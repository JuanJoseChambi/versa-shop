...
function Footer() {
    ...
    function liOptions (title:string) {
        return (
            <ul className="text-sm space-y-5 bg-redd-500">
                <li className="text-sm tracking-widest font-semibold text-white">{title}</li>
    ...
    function facebook () {
        return ( 
            <svg fill="currentColor" viewBox="0 0 24 24" className="w-[25px]" aria-hidden="true">
    ...
    function instagram () {
        return (
            <svg fill="currentColor" viewBox="0 0 24 24" className="w-[25px]" aria-hidden="true" data-darkreader-inline-fill="">
  ...
  return (
    <footer className="w-full h-auto relative bg-neutral-800 mt-auto ">
        ...
        <section className="w-full h-full flex justify-evenly items-center flex-col bg-redd-500">
            <section className="w-full py-16 flex justify-around items-center bg-yellowd-500">

                <section className="w-[30%] relative flex justify-center items-center bg-greend-500">
                    <h2 className="font-noto text-4xl font-semibold text-white">Versa</h2>
                </section>

                <section className="w-[50%] flex justify-between items-start bg-blued-500">
            ...
            <section className="w-area py-10 border-t border-b border-neutral-700 flex justify-between items-center bg-violetd-500 ">
            ...
            <section className="w-area bg-greend-500 py-5 flex justify-between items-center">
                <h3 className="text-white text-xs">© 2024 Versa. Todos los derechos reservados.</h3>
                <section className="text-white flex justify-center items-center gap-x-5">
                    {facebook()}
                    {instagram()}
                    {x()}
                    {git()}

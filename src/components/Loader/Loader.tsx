...
function Loader({active}:LoaderProp) {
  ...
  return (
    <main className="w-full min-h-screen max-h-screen fixed top-0 left-0 flex justify-center items-center flex-col bg-white z-[110]">
      ...
      <div className="w-[90%] h-[91vh] absolute border border-neutral-800 rounded-sm"></div>
